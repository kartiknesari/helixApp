...
function App() {
    return (
        <div className="h-screen w-screen bg-white dark:bg-black text-black dark:text-white flex overflow-hidden space-x-2 p-4">
            {/* <ThemeToggleButton /> */}
            {/* SECTION 1: Audio AI (Left 50%) */}
            <div className="w-1/2 h-full flex flex-col items-center justify-center border border-zinc-200 dark:border-zinc-800 bg-gradient-to-b from-white dark:from-black to-zinc-100 dark:to-zinc-900 rounded-4xl">
                {/* <ShineBorder borderWidth={2} duration={14} /> */}
            ...
            <div className="w-1/2 h-full flex flex-col space-y-2">
                ...
                <Link to="/recommender" className="h-1/2">
                    <div className="h-full flex-1 p-10 flex flex-col justify-center border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors group rounded-2xl">
                        {/* <ShineBorder
                        shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]}
                    /> */}
                        <span className="font-bold uppercase tracking-widest text-xs mb-2">
                            AI-Lite Match
                        </span>
                ...
                <Link to="/catalog" className="h-1/2">
                    <div className="h-full p-10 flex flex-1 flex-col justify-center border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors group rounded-2xl">
                        {/* <ShineBorder
                            shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]}
                        /> */}
                        <span className="font-bold uppercase tracking-widest text-xs mb-2">
